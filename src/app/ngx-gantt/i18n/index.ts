...
import { default as esEsLocale } from './locales/es-es';
import { GANTT_I18N_LOCALE_TOKEN } from './i18n';
import { Provider } from '@angular/core';

export * from './i18n';

export { zhHansLocale, zhHantLocale, enUsLocale, jaJpLocale, deDeLocale, ruRuLocale,esEsLocale };
...
export const i18nLocaleProvides: Provider[] = [
    ...
    { provide: GANTT_I18N_LOCALE_TOKEN, useValue: esEsLocale, multi: true }
];
